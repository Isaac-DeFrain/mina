...
let setup_daemon logger =
  ...
  and precomputed_blocks_path =
    flag "--precomputed-blocks-path"
      ...
      (optional string)
      ~doc:
        "PATH Path to write precomputed blocks to, for replay or archiving. \
         If PATH is a directory, precomputed blocks will be logged to \
         individual files within this directory. Otherwise, they will be \
